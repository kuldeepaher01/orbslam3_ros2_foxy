...
# Find built-in DBoW2
find_path(DBoW3_INCLUDE_DIR NAMES Thirdparty/DBoW3/src/BowVector.h
          PATHS ${ORB_SLAM3_ROOT_DIR})

find_library(DBoW3_LIBRARY NAMES DBoW3
             PATHS ${ORB_SLAM3_ROOT_DIR}/Thirdparty/DBoW3/build/src)
...
find_package_handle_standard_args(ORB_SLAM3  DEFAULT_MSG
                                  ORB_SLAM3_LIBRARY ORB_SLAM3_INCLUDE_DIR DBoW3_INCLUDE_DIR DBoW3_LIBRARY g2o_LIBRARY)

mark_as_advanced(ORB_SLAM3_INCLUDE_DIR ORB_SLAM3_LIBRARY )

set(ORB_SLAM3_LIBRARIES ${ORB_SLAM3_LIBRARY} ${DBoW3_LIBRARY} ${g2o_LIBRARY})
set(ORB_SLAM3_INCLUDE_DIRS ${ORB_SLAM3_INCLUDE_DIR} ${DBoW3_INCLUDE_DIR})
